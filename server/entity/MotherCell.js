...
MotherCell.prototype.update = function(gameServer) {
    ...
    // Spawn food
	var readytoSpawnMass = false;
	if (this.mass > 5000) readytoSpawnMass = true;
    while (readytoSpawnMass) 
	{
        this.spawnFood(gameServer);
        this.mass--;
		
		if (this.mass < 223)
			readytoSpawnMass = false;
    }
};
...
MotherCell.prototype.onConsume = function(consumer, gameServer)
{
